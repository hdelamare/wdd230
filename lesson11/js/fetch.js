  ...
  .then(function (jsonObject) {
    ...
    for (let i = 0; i < towns.length; i++ ) {
        if (i == 0 || i == 2 || i == 6) {
            ...
            if (i == 0) {
              townImage.setAttribute('src', '../lesson11/images/soda-springs-home.jpg');
              townImage.setAttribute('alt', 'Image of ' + towns[i].name);
              card.setAttribute('id', 'soda-card');
            } 
            if (i == 2) {
              townImage.setAttribute('src', '../lesson11/images/fish-haven-home.jpg');
              townImage.setAttribute('alt', 'Image of ' + towns[i].name);
              card.setAttribute('id', 'fish-card');
            }
            if (i == 6) {
              townImage.setAttribute('src', '../lesson11/images/preston-home.jpg');
              townImage.setAttribute('alt', 'Image of ' + towns[i].name);
