const sodaSprings = 'https://byui-cit230.github.io/weather/data/towndata.json';
fetch(sodaSprings)
  ...
  .then(function (soda) {
    ...
    for (let i = 0; i < towns.length; i++ ) {
        if (i = 0) {
            ...
            document.querySelector('#soda-springs-events').appendChild(sodaEvents);
}}});